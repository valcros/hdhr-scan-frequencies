...
Examples:
  ...
  %(prog)s --auto-openai      # Automatically query OpenAI
    ...
    try:
        ...
        print("\n" + "="*80)
        print("❌ ERROR: HDHomeRun Utility Not Found")
        print("="*80)
        print()
        print("WHAT HAPPENED:")
        print("  The 'hdhomerun_config' command-line utility is not installed or not")
        print("  in your system PATH.")
        print()
        print("WHY THIS MATTERS:")
        print("  This tool requires the official HDHomeRun utility to communicate")
        print("  with your device and scan channels.")
        print()
        print("HOW TO FIX:")
        print("  1. Download the HDHomeRun software package:")
        print("     → https://www.silicondust.com/support/downloads/")
        print("  2. Install the package for your operating system")
        print("  3. Verify installation by running: hdhomerun_config discover")
        print()
        print("NEED HELP?")
        print("  • Installation guide: https://www.silicondust.com/support/")
        print("  • Check logs: hdhr_scan.log")
        print("="*80 + "\n")
        return 1
        ...
        print()
        print("WHAT HAPPENED:")
        print("  The scan could not find any HDHomeRun devices on your network.")
        print()
        print("WHY THIS HAPPENS:")
        print("  • Device is not powered on")
        print("  • Device not connected to same network as this computer")
        print("  • Network firewall blocking device discovery")
        print("  • Device has network configuration issues")
        print()
        print("HOW TO FIX:")
        print("  1. Check device power and network connection")
        print("     → Look for solid green LED on device")
        print("     → Verify ethernet cable is connected")
        print("  2. Test device connectivity:")
        print("     → Run: hdhomerun_config discover")
        print("     → Or visit: http://my.hdhomerun.com")
        print("  3. Check firewall settings:")
        print("     → Allow UDP port 65001 for device discovery")
        print("  4. Try specifying device directly:")
        print("     → Use: --device-id YOUR_DEVICE_ID")
        print()
        print("NEED HELP?")
        print("  • Device setup: https://www.silicondust.com/support/")
        print("  • Check logs: hdhr_scan.log")
        print("="*80 + "\n")
        return 1
        ...
        print("="*80)
        print()
        print("  The scan was cancelled by user (Ctrl+C).")
        print("  Any progress has been lost.")
        print()
        print("  TIP: Use --quiet mode for automation that handles interrupts")
        print("="*80 + "\n")
        ...
        print(f"  • Check logs: hdhr_scan.log")
        print()
        if args.debug:
            print("STACK TRACE:")
            import traceback
            ...
            print("HOW TO GET MORE INFO:")
            print("  Run with --debug flag for detailed error information:")
            print(f"  → python main.py --debug")
            print()
        print("NEED HELP?")
        print("  • Report issue: https://github.com/valcros/hdhr-scan-frequencies/issues")
        print("  • Include: hdhr_scan.log file and command used")
        print("="*80 + "\n")
        return 1
